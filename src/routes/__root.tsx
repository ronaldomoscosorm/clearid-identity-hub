...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Console de integração R&M com o Genetec ClearID." },
      { name: "author", content: "R&M" },
      { property: "og:title", content: "Argus ClearID — Console R&M" },
      { property: "og:description", content: "Console de integração R&M com o Genetec ClearID." },
